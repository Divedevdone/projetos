...
document.querySelectorAll('.tab[data-fala], .botao-azul[data-fala]').forEach(tab => {
    tab.addEventListener('mouseenter', () => {
        ...
        if (tab.classList.contains('botao-azul')) {
...
function showMascotMessageBySection() {
    ...
    const messages = {
        'content1': `
            ...
            <p>Sou seu assistente virtual! Clique nas abas interativas para navegar entre as seções ou clique novamente para retornar!</p>
