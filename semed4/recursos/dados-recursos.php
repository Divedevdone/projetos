...
<body>
    ...
    <a href="../index.php#recursos.php" id="backToTop-voltar" class="fab-voltar" aria-label="Voltar">⬅</a>
    ...
    <script>
        (function () {
            ...
            fileInput.addEventListener('change', function () {
                ...
                xhr.open('POST', 'upload-recursos.php', true);
