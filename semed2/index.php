...
<body>
  ...
  <nav class="sidebar show" aria-label="Menu lateral">
    ...
    <div class="tab" data-file="content-rede.php" data-autor="🤖 RoboEdu:" data-fala="Interligação digital"  data-target="rede" data-hash="rede" data-pasta="rede"><span class="text-tab">5. Projetos do Núcleo</span></div>
