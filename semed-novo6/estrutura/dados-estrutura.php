...
<body>
    ...
    <br><br>
    <main>
        <h2>Núcleo de Educação Digital</h2>
        <p class="subtitulo">
    ...
    <a href="../index.php#estrutura.php" id="backToTop-voltar" class="fab-voltar" aria-label="Voltar">⬅</a>
    ...
    <script>
        (function () {
            ...
            fileInput.addEventListener('change', function () {
                ...
                xhr.open('POST', 'upload-estrutura.php', true);
