...
<body>
    ...
    if (confirm("Tem certeza que deseja excluir este arquivo?")) {
        ...
        const backToTopBtn = document.getElementById('backToTop');
            ...
            backToTopLabel.style.display = 'block';
            });

            backToTopBtn.addEventListener('mouseleave', () => {
            backToTopLabel.style.display = 'none';
            });
    </script>
    ...
    <a href="../index.php#cursos.php" id="backToTop-voltar" class="fab-voltar" aria-label="Voltar">⬅</a>
    ...
    <script>
        (function () {
            ...
            fileInput.addEventListener('change', function () {
                ...
                xhr.open('POST', 'upload-cursos.php', true);
