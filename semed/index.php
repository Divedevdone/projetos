...
<body>
    ...
    <!-- Conteúdo da página aqui... -->
     <div class="sidebar">
        ...
        <!--Aba 2-->
        <div class="tab" data-file="nucleo.html" data-autor="🤖 RoboEdu:"
        ...
        <!--Aba 3-->
        <div class="tab" data-file="documentos.html" data-autor="🤖 RoboEdu:" data-fala="Orientações pedagógicas"
        ...
        <!--Aba 4-->
        <div class="tab" data-file="midiatica.html" data-autor="🤖 RoboEdu:" data-fala="Materiais digitais"
        ...
        <!--Aba 5-->
        <div class="tab" data-file="rede.html" data-autor="🤖 RoboEdu:" data-fala="Interligação digital"
        ...
        <!--Aba 6-->
        <div class="tab" data-file="recursos.html" data-autor="🤖 RoboEdu:" data-fala="Materiais pedagógicos"
        ...
        <!--Aba 7-->
        <div class="tab" data-file="formacao.html" data-autor="🤖 RoboEdu:" data-fala="Certificações"
    ...
    <?php if (isset($_SESSION["usuario"])): ?>
    <div class="btn-add" onclick="addData()" title="Editar arquivos">
    ...
    <div id="mascotModal" class="modal">
        <div class="modal-content">
            ...
            <p>Sou seu assistente virtual! Clique nas abas coloridas para explorar todos os recursos educacionais,
                clique em mim para tirar dúvidas sempre que precisar.</p>
            <p><strong>💡 Dica:</strong> Clique nas abas interativas para navegar entre as seções ou clique novamente
                para retornar!</p>
