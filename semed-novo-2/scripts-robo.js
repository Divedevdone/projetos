    ...
    if (roboEduAtivo) {
        ...
        showCustomAlert(`
            ...
            <div style="text-align: center; margin-top: 1rem;">
                <button onclick="closeCustomAlert()" style="background: #42519C; color: white; border: none; padding: 20px 40px; border-radius: 35px; cursor: pointer;">Entendi!</button>
            </div>
        `);
    } else {
        // RoboEdu desligado
...
// FUNÇÃO PARA TROCAR DE SEÇÃO E ATUALIZAR A SEÇÃO ATUAL
function changeSection(sectionName, tabElement) {
...
// Mensagens do RoboEdu para cada seção
const messages = {
    'index': `
        ...
        <div style="text-align: center; margin-top: 1rem;">
            <button onclick="closeCustomAlert()" style="background: #42519C; color: white; border: none; font-size: 35px; padding: 20px 40px; border-radius: 35px; cursor: pointer;">Entendi!</button>
...
// Função para adicionar dados (mencionada no HTML)
function addData() {
    console.log('Função addData chamada');
